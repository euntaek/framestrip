...
- **Region selection** — capture only the component you care about, not the entire screen
...
> **Note:** FrameStrip is not code-signed yet. Right-click the app and select "Open" to bypass the Gatekeeper warning.
...
9. Paste into Claude, GPT, or your preferred AI with `@path-to-frames`
...
Pay attention to the stagger timing between elements.
```

Add your own instruction at the end to tell AI what to do — for example:

- `Implement this UI animation in SwiftUI using spring timing.`
